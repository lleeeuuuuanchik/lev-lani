<script setup>
/**
 * Лейаут админки: sidebar с навигацией + slot. Прелоадер через Teleport.
 */
...
.adm__logout
{
	...
	&:hover { background: rgba(255,77,109,0.06); color: $red; }
}
...
.adm__empty svg { color: rgba(255,255,255,0.12); }
.adm__empty p { font-size: 1rem; font-weight: 500; color: $textSecondary; margin: 0; }
.adm__empty span { font-size: 0.84rem; }
...
.adm__icon-btn
{
	...
	&:hover { background: rgba(255,255,255,0.07); border-color: $borderHover; color: $textPrimary; }
	&--danger:hover { background: rgba(255,77,109,0.07); border-color: rgba(255,77,109,0.3); color: $red; }
}
...
.adm__icon-option
{
	...
	&.is-selected svg,
	&.is-selected .lucide { color: $roseGold; }
}
